...
class VectorTileService {
  constructor() {
    ...
    this.tileSources = {
      ...
      'nsw-part1': 'https://api.maptiler.com/tiles/01961a2c-f4ea-7748-a9a9-e98d2dcab3dc/tiles.json?key=DFSAZFJXzvprKbxHrHXv',
      'nsw-part2': 'https://api.maptiler.com/tiles/019619db-0a35-79cb-b098-2ac8ef8d8213/tiles.json?key=DFSAZFJXzvprKbxHrHXv',
      'queensland': 'https://api.maptiler.com/tiles/019619cb-40fa-7392-ac45-0a2bee28806b/tiles.json?key=DFSAZFJXzvprKbxHrHXv',
      'south-australia': 'https://api.maptiler.com/tiles/019619a2-1890-7dc3-b3a5-cd6ede88f26a/tiles.json?key=DFSAZFJXzvprKbxHrHXv',
      'western-australia': 'https://api.maptiler.com/tiles/01961a53-6bf9-70b5-96f6-60c0be7cc9d0/tiles.json?key=DFSAZFJXzvprKbxHrHXv',
      'nt-act': 'https://api.maptiler.com/tiles/0196800b-307f-74ac-9634-e1004495bdf0/tiles.json?key=DFSAZFJXzvprKbxHrHXv',
      // New Zealand
      'new-zealand': 'https://api.maptiler.com/tiles/01968004-0de6-7e5e-8dc8-9e452336a543/tiles.json?key=DFSAZFJXzvprKbxHrHXv'
    };
