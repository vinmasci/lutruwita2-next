...
export interface BasePOI {
  id: string;  // Required in frontend, will be set from MongoDB's _id
  routeId?: string; // ID of the route this POI belongs to
...
// Input types for creating new POIs - id will be generated by MongoDB
export type NewDraggablePOIInput = Omit<DraggablePOI, 'id'>;
export type NewPlaceNamePOIInput = Omit<PlaceNamePOI, 'id'>;
export type NewPOIInput = NewDraggablePOIInput | NewPlaceNamePOIInput;
