...
export const POIViewer = ({ poi: initialPoi, onClose, onUpdate, displayMode = "drawer" }) => {
    ...
    // Render content for both drawer and modal
    const renderContent = () => {
        return (
            _jsxs(Box, {
                sx: {
                        ...
                        children: [
                            ...
                            _jsxs(Box, {
                                sx: { 
                                    ...
                                    flexGrow: 1, 
                                    gap: 1,
                                    justifyContent: displayMode === "modal" ? 'space-between' : 'flex-start',
                                    mb: displayMode === "modal" ? 3 : 0
                                },
                                children: [
                                    _jsxs(Box, {
                        ...
                        children: [
                            _jsx(Box, {
                                sx: {
                                    ...
                                    width: displayMode === "modal" ? '100%' : 'auto',
                                },
                                children: isEditing ? (
                                    _jsx(TextField, {
                                        fullWidth: true,
