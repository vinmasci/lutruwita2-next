...
export const POIViewer = ({ poi: initialPoi, onClose, onUpdate }) => {
    ...
    const handleSave = () => {
        if (onUpdate) {
            const updates = {};
            if (editedName !== poi.name)
                updates.name = editedName;
            if (editedDescription !== poi.description)
                        ...
                        flexDirection: 'column'
                                        ...
                                        '&:hover': {
                                            backgroundColor: 'rgba(255, 255, 255, 0.1)'
                                                ...
                                                color: categoryColor,
                                                fontSize: '24px'
                                            } }), isEditing ? (_jsx(TextField, { value: editedName, onChange: (e) => setEditedName(e.target.value), variant: "standard", sx: {
                                        ...
                                        mb: 2
                                                ...
                                                color: categoryColor,
                                                fontSize: '24px'
                                            } }), _jsx(Typography, { variant: "body2", color: "text.secondary", children: POI_CATEGORIES[poi.category].label })] }), _jsx(Box, { sx: {
                                        mb: 3,
                                        p: 2,
                                        borderRadius: 1,
                                        bgcolor: 'rgba(30, 136, 229, 0.1)',
                                        border: '1px solid rgba(30, 136, 229, 0.2)'
                                    }, children: isEditing ? (_jsx(TextField, { fullWidth: true, multiline: true, minRows: 3, value: editedDescription, onChange: (e) => setEditedDescription(e.target.value), variant: "outlined", sx: {
                                            '& .MuiOutlinedInput-root': {
                                        ...
                                        } })) : (_jsxs(_Fragment, { children: [_jsx(Typography, { variant: "overline", color: "info.light", sx: { display: 'block', mb: 1 }, children: "Details" }), _jsx(Typography, { variant: "body1", sx: { whiteSpace: 'pre-wrap' }, children: poi.description || 'No description' })] })) }), _jsxs(Box, { children: [_jsxs(Box, { sx: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: 1 }, children: [_jsxs(Typography, { variant: "subtitle2", color: "text.secondary", children: ["Photos (", (poi.photos?.length || 0) + newPhotos.length, ")"] }), isEditing && (_jsxs(Button, { component: "label", variant: "outlined", size: "small", sx: { color: 'white', borderColor: 'rgba(255, 255, 255, 0.23)' }, children: ["Add Photos", _jsx("input", { type: "file", hidden: true, multiple: true, accept: "image/*", onChange: (e) => {
                                                ...
                                                gap: 1
                                            }, children: [poi.photos?.map((photo, index) => (_jsxs(Box, { onClick: () => setSelectedPhoto(photo.url), sx: {
                                                        aspectRatio: '1',
                                                        ...
                                                        '&:hover': {
                                                            transform: 'scale(1.02)'
                                                                ...
                                                                height: '100%',
                                                                objectFit: 'cover'
                                                            } }), isEditing && (_jsx(IconButton, { size: "small", onClick: (e) => {
                                                                e.stopPropagation();
                                                                if (poi.photos) {
                                                            ...
                                                            }, children: _jsx(Close, { fontSize: "small" }) }))] }, index))), newPhotos.map((photo, index) => (_jsxs(Box, { sx: {
                                                        aspectRatio: '1',
                                                        backgroundColor: 'rgba(35, 35, 35, 0.9)',
                                                        borderRadius: 1,
                                                        overflow: 'hidden',
                                                        position: 'relative',
                                                    }, children: [_jsx("img", { src: photo.url, alt: photo.caption || `New photo ${index + 1}`, style: {
                                                                width: '100%',
                                                                height: '100%',
                                                                objectFit: 'cover'
                                                            } }), isEditing && (_jsx(IconButton, { size: "small", onClick: () => handleRemoveNewPhoto(index), sx: {
                                                                position: 'absolute',
                                                                top: 4,
                                                                right: 4,
                                                                backgroundColor: 'rgba(0, 0, 0, 0.5)',
                                                            ...
                                                            }, children: _jsx(Close, { fontSize: "small" }) }))] }, `new-${index}`)))] })] }), _jsx(Box, { sx: {
                                        mt: 3,
                                        display: 'flex',
                                        gap: 1,
                                        ...
                                        pt: 2
                                    }, children: !isEditing ? (_jsxs(_Fragment, { children: [_jsx(Button, { variant: "outlined", startIcon: _jsx(Edit, {}), onClick: handleStartEditing, color: "info", sx: {
                                                ...
                                                }, children: "Edit" }), _jsx(Button, { variant: "outlined", startIcon: _jsx(Delete, {}), onClick: () => {
                                                    removePOI(poi.id);
                                                    onClose();
                                                }, color: "error", sx: {
                                                ...
                                                }, children: "Delete" })] })) : (_jsxs(_Fragment, { children: [_jsx(Button, { variant: "outlined", startIcon: _jsx(Cancel, {}), onClick: handleCancelEditing, sx: {
                                                    color: 'white',
                                                    borderColor: 'rgba(255, 255, 255, 0.23)',
                                                    '&:hover': {
                                                        borderColor: 'rgba(255, 255, 255, 0.5)'
                                                    }
                                                }, children: "Cancel" }), _jsx(Button, { variant: "contained", startIcon: _jsx(Save, {}), onClick: handleSave, color: "primary", children: "Save" })] })) })] })] }) }), _jsxs(Dialog, { open: Boolean(selectedPhoto), onClose: () => setSelectedPhoto(null), maxWidth: "xl", fullWidth: true, children: [_jsx(IconButton, { onClick: () => setSelectedPhoto(null), sx: {
                            position: 'absolute',
                            right: 8,
                            top: 8,
                            color: 'white',
