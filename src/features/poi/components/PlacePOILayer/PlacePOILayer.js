...
export const PlacePOILayer = () => {
    ...
    useEffect(() => {
        ...
        try {
            ...
            const handleMouseMove = (e) => {
                ...
                map.setLayoutProperty(HIGHLIGHT_LAYER, 'visibility', hasData ? 'visible' : 'none');
                // Update cursor
            ...
            const handleClick = async (e) => {
                ...
                const hasPOIs = pois.some(poi => poi.coordinates[0] === place.coordinates[0] &&
    ...
    useEffect(() => {
        const setupMarkers = async () => {
            ...
            const placePois = pois.filter((poi) => poi.type === 'place');
    ...
    return (_jsx(PlacePOIDetailsDrawer, { isOpen: isDrawerOpen, onClose: () => setSelectedPlace(null), placeId: selectedPlace?.id || null, placeName: selectedPlace?.name || '', description: selectedPlace?.description, photos: selectedPlace?.photos }));
};
