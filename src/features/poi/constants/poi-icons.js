export const POI_ICONS = [
    ...
    { name: 'ChevronsRightLeft', category: 'trail-information', label: 'Rough Surface', description: 'Rough or uneven road surface', style: { color: '#ff6348' } },
    { name: 'AudioWaveform', category: 'trail-information', label: 'Single Track', description: 'Narrow single track section', style: { color: '#ff6348' } },
    { name: 'Route', category: 'trail-information', label: 'Trailhead', description: 'Start of a trail or track', style: { color: '#ff6348' } },
    { name: 'RailTrail', category: 'trail-information', label: 'Rail Trail', description: 'Former railway line converted to trail', style: { color: '#ff6348' } },
    { name: 'HikeABike', category: 'trail-information', label: 'Hike-a-bike', description: 'Section where bike must be carried', style: { color: '#ff6348' } },
    { name: 'WaterCrossing', category: 'trail-information', label: 'Water Crossing', description: 'River, stream, or water crossing', style: { color: '#ff6348' } },
    { name: 'RemoteArea', category: 'trail-information', label: 'Remote Area', description: 'Remote or isolated area', style: { color: '#ff6348' } },
    // Accommodation
