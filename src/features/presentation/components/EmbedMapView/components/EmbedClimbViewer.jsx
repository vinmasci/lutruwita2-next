...
import { ImageSlider } from '../../../../presentation/components/ImageSlider/ImageSlider';
import { ResponsiveLine } from '@nivo/line';

export const EmbedClimbViewer = ({ climb, route, onClose }) => {
...
export default EmbedClimbViewer;
