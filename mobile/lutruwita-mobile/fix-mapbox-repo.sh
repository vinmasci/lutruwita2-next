...
# Script to fix Mapbox SDK repository issue

echo "Starting Mapbox SDK repository fix..."

# Step 1: Add Mapbox SDK repository to Podfile
echo "Adding Mapbox SDK repository to Podfile..."

# Create a backup of the original Podfile
cp ios/Podfile ios/Podfile.backup

# Add the Mapbox SDK repository to the Podfile
cat > ios/Podfile << EOL
...
# Step 2: Run pod install with architecture fix (without repo-update this time)
echo "Running pod install with architecture fix (without repo-update)..."
cd ios
arch -x86_64 pod install
cd ..

echo "Mapbox SDK pod install attempt completed!"
