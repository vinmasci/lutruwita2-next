...
# Script to update Mapbox version and reinstall dependencies

echo "Starting Mapbox version update process..."

# Step 1: Clean the project
echo "Cleaning the project..."
npx expo prebuild --clean

# Step 2: Remove node_modules and reinstall dependencies
echo "Removing node_modules and reinstalling dependencies..."
rm -rf node_modules
npm install

# Step 3: Update Podfile to use both Mapbox and CocoaPods sources
echo "Updating Podfile to use correct sources..."
cat > ios/Podfile << EOL
...
# Add both sources to ensure all pods can be found
...
echo "Mapbox version update completed!"
