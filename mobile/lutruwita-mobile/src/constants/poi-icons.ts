/**
 * POI icon definitions for the mobile app
 * Based on the web app implementation but adapted for mobile
 */

import { POICategory, POIIconName } from '../types/poi';

// POI icon definition interface
