...
# Script to fix CocoaPods by using CDN instead of Git source

echo "Starting CocoaPods CDN fix..."

# Step 1: Remove the potentially incomplete Git clone of the CocoaPods specs repo
echo "Removing CocoaPods trunk repo (if it exists)..."
pod repo remove trunk || true

# Step 2: Update Podfile to use CDN source
echo "Updating Podfile to use CDN source..."

# Create a backup of the original Podfile
cp ios/Podfile ios/Podfile.backup

# Add the Mapbox SDK repository to the Podfile and use CDN source
cat > ios/Podfile << EOL
...
# Use CDN source instead of Git
source 'https://cdn.cocoapods.org/'
# Add Mapbox SDK repository
source 'https://github.com/mapbox/mapbox-gl-native-ios.git'

# @generated begin @rnmapbox/maps-rnmapboxmapsimpl - expo prebuild (DO NOT MODIFY) sync-d79d90da9f6868b961d373d7c8a61296eeaef617
\$RNMapboxMapsImpl = 'mapbox'
\$RNMapboxMapsDownloadToken = 'sk.eyJ1IjoidmlubWFzY2kiLCJhIjoiY205ZjcyNDRoMHcybjJqb2Fsd2p4NTFzZyJ9.RypRAeS61ChnzZJRSViOpg'
\$RNMapboxMapsVersion = '10.0.15'
...
# Step 3: Run pod install with the CDN source
echo "Running pod install with CDN source..."
cd ios
arch -x86_64 pod install
cd ..

echo "CocoaPods CDN fix completed!"
